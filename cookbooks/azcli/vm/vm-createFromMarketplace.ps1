...
$rg = "rg-myvm"
$vmName = "vm-myvm"
$publisher = Read-Host "Enter publisher name"
$offer = Read-Host "Enter publisher offer"
$sku = Read-Host "Enter publisher sku"
$adminUser = Read-Host "Enter vm admin username"
$adminPass = Read-Host -MaskInput "Enter vm admin username"
$vmSize = "Standard_B1s"
